 ...
 * (c) 2006 Christian Birkl
 * https://www.codeproject.com/Articles/13345/DbMon-NET-A-simple-NET-OutputDebugString-capturer
 * 
 * Modified by Max Makes Mods for Half-Life: VR: Added IsStarted (2019-07-25)
 * 
 */
...
namespace DbMon.NET
{
    ...
    public sealed class DebugMonitor
    {
        ...
        /// <summary>
        /// true if monitor is started
        /// </summary>
        public static bool IsStarted { get { return m_Capturer != null; } }
