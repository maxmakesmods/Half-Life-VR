  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="content_row">
        <a class="button" href="https://github.com/maxmakesmods/Half-Life-VR">
      ...
      <div class="content_row">
        ...
        <a class="button button2" href="https://github.com/maxmakesmods/Half-Life-VR/releases/download/<?php echo $MOD_VERSION; ?>/HLVR_<?php echo $MOD_VERSION; ?>-Installer.exe">
        ...
        <a class="button button2" href="https://github.com/maxmakesmods/Half-Life-VR/releases/download/<?php echo $MOD_VERSION; ?>/HLVR_<?php echo $MOD_VERSION; ?>.zip">
          <div class="button_text">
        ...
        <br><br>
        <a href="https://github.com/maxmakesmods/Half-Life-VR/releases/">Older versions</a>
      </div>

      <div class="content_row">
        <div class="content_title"><h3>Support</h3></div>
        <a class="button button6" href="https://www.patreon.com/maxmakesmods">
          <img class="button_icon" src="patreon.png" alt="patreon logo" title="Support">
        </a>
        <a class="button button6" href="https://www.paypal.me/maxmakesmods">
