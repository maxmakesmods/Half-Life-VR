...
// Intercepter functions for VR HUD rendering - Max Makes Mods, 2018-01-07
...
inline int SPR_Height( HSPRITE_VALVE x, int f )	{ return gEngfuncs.pfnSPR_Height(x, f); }
inline int SPR_Width( HSPRITE_VALVE x, int f )	{ return gEngfuncs.pfnSPR_Width(x, f); }
...
// Added NormalizeAngles and GetAnglesFromVectors - Max Makes Mods, 2017-08-17
