...
// Returns a pointer to a model_t instance holding BSP data for the current map - Max Makes Mods, 2018-01-21
...
// Returns a pointer to a model_t instance holding BSP data for this entity's BSP model (if it is a BSP model) - Max Makes Mods, 2018-01-21
