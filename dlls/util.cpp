...
// Find entity using a lambda expression - Max Makes Mods, 2017-12-28
...
// Loops over all entities - Max Makes Mods, 2017-12-28
...
// For finding triggers that are intercepted by a line between two points (used to trigger stuff when teleporting in VR) - Max Makes Mods, 2018-01-10
...
// Returns true if the given bbox intersects with (or is completely enclosed by) something solid - Max Makes Mods, 2017-12-27
...
// Moved all the entity functions here for proper debugging (no more inline) - Max Makes Mods, 2020-03-04
