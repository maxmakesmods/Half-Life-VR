...
void ClientCommand( edict_t *pEntity )
{
	...
	else if (FStrEq(pcmd, "vrupd_hmd") || FStrEq(pcmd, "vrupd_lft") || FStrEq(pcmd, "vrupd_rt"))	// Client sends update for VR related data - Max Makes Mods, 2017-08-18
	{
		int size = CMD_ARGC();
		if (size > 3)
		{
			...
			if (FStrEq(pcmd, "vrupd_hmd") && size == 8/*11*/)
			{
