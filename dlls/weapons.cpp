...
void CBasePlayerWeapon::ItemPostFrame( void )
{
	...
	if ((m_pPlayer->pev->button & IN_ATTACK2 || m_pPlayer->GetAnalogFire() < 0.f) && CanAttack( m_pPlayer, m_flNextSecondaryAttack, gpGlobals->time, UseDecrement() ) )
	{
	...
	else if ((m_pPlayer->pev->button & IN_ATTACK || m_pPlayer->GetAnalogFire() > 0.f) && CanAttack( m_pPlayer, m_flNextPrimaryAttack, gpGlobals->time, UseDecrement() ) )
	{
