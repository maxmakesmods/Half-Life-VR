...
public:
	...
	inline float LengthSquared() const { return x * x + y * y; }  // Added squared length for convenience - Max Makes Mods, 2021-03-11
...
public:
	...
	inline float LengthSquared() const { return x * x + y * y + z * z; }  // Added squared length for convenience - Max Makes Mods, 2018-01-28
