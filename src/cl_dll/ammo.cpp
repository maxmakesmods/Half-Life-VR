...
HSPRITE_VALVE ghsprBuckets;  // Sprite for top row of weapons menu
...
HSPRITE_VALVE* WeaponsResource::GetAmmoPicFromWeapon(int iAmmoId, wrect_t& rect)
{
	for (int i = 0; i < MAX_WEAPONS; i++)
	{
...
int CHudAmmo::Draw(float flTime)
{
	...
	// Draw Weapon Menu
	// DrawWList(flTime); Don't draw HUD weapons in VR - Max Makes Mods, 2018-01-07

	// Draw ammo pickup history
	// gHR.DrawAmmoHistory( flTime ); Don't draw ammo pick up history in VR - Max Makes Mods, 2018-01-07
