...
public:
	...
	// For easy detection of female NPCs to change audio files in sound.cpp - Max Makes Mods, 2018-11-23
...
{
	{tlFaceTargetScared,
	 (int)std::size(tlFaceTargetScared),
	 bits_COND_HEAR_SOUND |
		 bits_COND_NEW_ENEMY,
	 bits_SOUND_DANGER,
	 "FaceTargetScared"},
...
{
	{tlScientistStartle,
	 (int)std::size(tlScientistStartle),
	 bits_COND_NEW_ENEMY |
		 bits_COND_SEE_ENEMY |
		 bits_COND_SEE_HATE |
		 bits_COND_SEE_FEAR |
