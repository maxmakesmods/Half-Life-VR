...
//
	...
	if (!pmove->cmd.forwardmove && !pmove->cmd.sidemove && !pmove->cmd.upmove)
	{
		...
		wishvel[2] = 0;	// No gravity under water in VR - Max Makes Mods, 2018-02-11
	}
	else  
	{
...
int PM_CheckStuck (void)
{
	...
	if (hitent != 0 )	// Only get stuck on world, not on entities - Max Makes Mods, 2018-02-11
	{
...
// Ah, who doesn't love redundant copypaste code all over the place - Max Makes Mods, 2018-11-17
